        ...
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] md:text-xs text-gray-500 leading-none -mt-0.5">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            {isLoggedIn ? (
              <div className="flex items-center gap-3 ml-4 pl-4 border-l border-gray-200">
                ...
                <Link
                  to={getDashboardPath()}
                  className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-lg hover:shadow-lg transition-all duration-300 flex items-center gap-2 hover:scale-105"
                >
                ...
                <button
                  ...
                  className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg transition-all duration-300 flex items-center gap-2 hover:shadow-lg"
                >
              ...
              <>
                <div className="px-4 py-3 text-sm text-gray-600 border-t border-gray-100 mt-2 pt-3">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white text-sm font-bold">
                      {userName.charAt(0).toUpperCase()}
                    </div>
                    <div>
                      <div className="font-semibold text-gray-800">{userName}</div>
                      <div className="text-xs text-gray-400 flex items-center gap-1">
                        <span className="bg-gray-100 px-2 py-0.5 rounded-full capitalize">{userRole}</span>
                      </div>
                    </div>
                  </div>
                </div>
